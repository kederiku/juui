...
| **Garde de non-dérive**     | Un test dont le seul rôle est d'empêcher deux copies de diverger — le catalogue d'espèces recopié entre deux modules, par exemple.                                                                                                                                                                    | `tests/modules/scheduling/test_species_vocabulary.py`      |
