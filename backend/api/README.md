...
| `alembic.ini` réattribué à BACK-07, et l'entrypoint corrigé            | INFRA-04 écrivait que le fichier arriverait avec BACK-05 ; la carte BACK-07 le porte dans sa propre portée. Trois endroits l'affirmaient à tort — [`entrypoint.sh`](../../docker/api/entrypoint.sh), son message de journal et le README de la racine — la page [L'image du service d'API](https://kederiku.github.io/juui/infrastructure/image-api#ce-que-fait-lentrypoint) en a hérité — et rien ne les aurait démentis avant BACK-07. |
...
L'arbitrage remonte à SETUP-05, il est consigné au [registre des écarts](https://kederiku.github.io/juui/ecarts/setup#écarts-assumés-avec-le-ticket-setup-05).
