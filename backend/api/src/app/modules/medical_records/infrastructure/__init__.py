"""Couche exterieure du module medical_records : les details remplacables.

Elle DEPEND du domaine, jamais l'inverse. Un seul adaptateur y vit pour
l'instant : `db/` -- les deux tables du module et les depots qui traduisent
leurs lignes en entites. Les routes arriveront avec BACK-30.
