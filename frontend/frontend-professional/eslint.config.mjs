...
/**
 * Configuration ESLint de frontend-professional (FRONT-01).
 *
 * Preset `next` : le socle `base`, les regles de hooks de `react`, et les 22
 * regles de `@next/eslint-plugin-next` en variante core-web-vitals.
 *
