...
/**
 * Configuration ESLint de frontend-admin (FRONT-03).
 *
 * Preset `next`, comme les deux autres applications : le socle `base`, les
 * regles de hooks de `react`, et les 22 regles de `@next/eslint-plugin-next` en
 * variante core-web-vitals.
 *
